...
L["DFFilter"] = "Damage Filter"
L["DFFilterD"] = "Controls the minimum amount a damage needs to be to appear in EavesDrop. Good for filtering out frequent small damage like"
L["ACCDelay"] = "Healing Delay"
L["ACCDelayD"] = "Delay healing display to accumulate small heals"
L["MLock"] = "Lock Frame"
